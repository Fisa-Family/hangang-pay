...
class BlockchainOrderingSequenceAllocatorTest {

    @Mock private BlockchainOrderingStateJpaRepository repository;

    private BlockchainOrderingSequenceAllocator allocator;

    @BeforeEach
    void setUp() {
        allocator = new BlockchainOrderingSequenceAllocator(repository);
    }
