...
Table bank_institution {
  ...
  account_number varchar(50) [note: '기관 자체 운영 계좌번호']
  wallet_address varchar(100) [note: '기관 자체 지갑 주소 (CBDC mint/burn 권한자)']
  encrypted_private_key text [note: '기관 지갑의 개인키 (mint/burn 권한)']
  enode_url varchar(512) [note: '블록체인 노드 URL']
  rpc_endpoint varchar(255) [note: 'RPC 엔드포인트']
...
Table bank_account {
  ...
  balance decimal(18,2) [not null, default: 0, note: '현재 잔액 (snapshot)']
...
Table account_ledger {
  ...
  balance_after decimal(18,2) [not null, note: '거래 후 잔액']
