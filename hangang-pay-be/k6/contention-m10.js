...
/**
 * 가맹점 row-lock 경합 측정 — 가맹점 10개 (VU 400 → 가맹점 10에 분산, 가맹점당 40 VU)
 *
 * 실행 (k6 메트릭도 Grafana로):
 *   K6_PROMETHEUS_RW_SERVER_URL=http://localhost:9090/api/v1/write \
 *   k6 run -o experimental-prometheus-rw k6/contention-m10.js
 * 콘솔만:
 *   k6 run k6/contention-m10.js
 *
...
const AMOUNT = Number(__ENV.AMOUNT || 2); // 2원
