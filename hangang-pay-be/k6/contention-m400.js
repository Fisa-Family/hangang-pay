...
/**
 * 가맹점 row-lock 경합 측정 — 가맹점 400개 (VU 400 → 1:1, 경합 없음 = 기준선)
 *
 * 실행 (k6 메트릭도 Grafana로):
 *   K6_PROMETHEUS_RW_SERVER_URL=http://localhost:9090/api/v1/write \
 *   k6 run -o experimental-prometheus-rw k6/contention-m400.js
 * 콘솔만:
 *   k6 run k6/contention-m400.js
 *
...
// ★ 이 파일 고정값
const MERCHANT_COUNT = 400;
const AMOUNT = Number(__ENV.AMOUNT || 5); // 4원
