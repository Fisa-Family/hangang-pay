...
export function UserProfileCard({ profile, onClick }: UserProfileCardProps) {
  ...
  return (
    <Component
      ...
      onClick={onClick}
      className={cn(
        'flex w-full items-center gap-4 rounded-2xl border border-border/40 bg-card p-5 text-left shadow-sm',
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 text-xs text-muted-foreground">{formattedPhone}</p>
